...
resource "aws_s3_bucket" "bucket" { #tfsec:ignore:aws-s3-enable-bucket-logging
...
resource "aws_s3_bucket_server_side_encryption_configuration" "bucket" { #tfsec:ignore:aws-s3-encryption-customer-key
